...
obstacle_cartesian_corners = [(3.0, -1.0), (6.0, -1.0), (6.0, 1.0), (3.0, 1.0)] #[(1.5, -0.25), (2.5, -0.25), (2.5, 0.25), (1.5, 0.25)]
...
for l_start_idx in range(-n, n + 1):
    y_connection = l_start_idx /2. # /2.
    #full_path = Clothoid.G1Hermite(1, l_start_idx/5., path_seg1.ThetaEnd, 5, l_end_idx/5.0,0)
    path_seg1 = Clothoid.G1Hermite(0, 0, 0, 1, y_connection, 0) #(0, 0, 0, 1, y_connection, 0)
    ...
    for l_end_idx in range(-n, n + 1):
        path_seg2 = Clothoid.G1Hermite(1, y_connection, path_seg1.ThetaEnd, 10, l_end_idx / 10., 0)
